function init() {
    ...
    $("#loadSampleVideo").click(function() {
        ...
        if (vid.canPlayType("video/mp4")) {
            ...
            url = "http://ie.microsoft.com/testdrive/ieblog/2011/nov/pp4_blog_demo.webmvp8.webm";
        }
    ...
    $("#loadCaptionFileFromUrl").click(function() {
        ...
        s.setAttribute("src", "http://www.baccano.com/proxyvtt.ashx?vtt=" + $("#ttURL").val());
    ...
    $("#loadSampleCaptionFile").click(function() {
        $("#ttURL").val("http://ie.microsoft.com/testdrive/ieblog/2011/nov/ppb4_blog_demo_en.vtt");
	...
	// ADARSH
    LoadVideoSource("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/f06ac097-08a4-4ca4-b45c-e5b5cd3f4c7f/Hololens%20Demo.mp4");
    $("#ttURL").val("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/e0ebde47-db9a-4e79-9d72-1a8f6afba7ba/Hololens%20Demo.mp4.ttml");
    $("#loadCaptionFileFromUrl").click();
